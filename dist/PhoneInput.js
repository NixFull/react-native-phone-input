...
const PhoneInput = ({ initialCountry = "US", value, style = {}, textStyle = {}, dismissKeyboard = true, autoFocus = false, onChange = () => { }, onChangePhoneNumber = () => { }, icon = react_1.default.createElement(react_1.default.Fragment, null), countryContainerStyle = {}, dialcodeStyle = {}, placeholder = "", disabled = false, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(react_native_1.View, { style: Object.assign({ borderColor: "#eeeeee", flexDirection: "row" }, style) },
            react_1.default.createElement(react_native_1.TouchableOpacity, { style: [
                    { flexDirection: "row", alignItems: "center" },
                    countryContainerStyle,
                ], onPress: openCountryPicker, disabled: disabled },
            ...
            react_1.default.createElement(react_native_1.TextInput, { dataDetectorTypes: ["phoneNumber"], keyboardType: "phone-pad", onChangeText: handleChangeText, autoFocus: autoFocus, value: phoneNumber, editable: disabled, style: Object.assign({ borderWidth: 0, flexGrow: 1, height: 40, paddingLeft: 0 }, textStyle), placeholder: placeholder })),
